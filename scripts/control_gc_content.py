    ...
    for i, sequence in enumerate(sequences):
        ...
        for _ in range(samples_per_sequence):
            ...
            for i, step in enumerate(step_generator):
                ...
                if is_within_threshold(control_candidate_gc_content, sequence_gc_content, threshold_flexibility):
                    writer.writerow({
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sequence_path", type=str,
            default="/storage/group/izg5139/default/nicole/MirrorRTR/chm13v2_regex_motifs.txt")
    parser.add_argument("--chromosome", type=str, default="chr1")
    parser.add_argument("--fasta", type=str, default="/storage/group/izg5139/default/nicole/g4_t2t_analysis/datasets/chm13v2.0.fa.gz")
    parser.add_argument("--mode", type=str, default="sequencehunter", choices=["g4hunter", "consensus"])
    parser.add_argument("--controls_path", type=str, default="controls_sequences_regex")
